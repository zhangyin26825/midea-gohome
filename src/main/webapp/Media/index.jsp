...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${StaticResourcesUrl}/midea-gohome/Media/css/reset.css?version=${version}" />
    <link rel="stylesheet" type="text/css" href="${StaticResourcesUrl}/midea-gohome/Media/css/swiper-3.4.0.min.css?version=${version}" />
    <link rel="stylesheet" type="text/css" href="${StaticResourcesUrl}/midea-gohome/Media/css/cityPicker.css?version=${version}">
    <link rel="stylesheet" type="text/css" href="${StaticResourcesUrl}/midea-gohome/Media/css/index.css?version=${version}" />
...
<div class="music-btn" id="music">
    ...
    <audio id="audio" src="${StaticResourcesUrl}/midea-gohome/Media/audio/media1.mp3?version=${version}"  type="audio/mp3" loop></audio>
</div>
...
<div class="music-btn2 hidden" id="music2" >
    ...
    <audio id="audio2" src="${StaticResourcesUrl}/midea-gohome/Media/audio/3.mp3?version=${version}" type="audio/mp3" loop></audio>
</div>
...
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Media/js/jquery-1.11.3.min.js?version=${version}"></script>
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Others/js/jquery.cookie.min.js?version=${version}"></script>
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Media/js/cityPicker.js?version=${version}"></script>
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Media/js/swiper-3.4.0.jquery.min.js?version=${version}"></script>
<script src="${StaticResourcesUrl}/midea-gohome/Media/js/hidpi-canvas.js?version=${version}" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Media/js/index.js?version=${version}"></script>
<script type="text/javascript" src="${StaticResourcesUrl}/midea-gohome/Media/js/img-base64.js?version=${version}"></script>
